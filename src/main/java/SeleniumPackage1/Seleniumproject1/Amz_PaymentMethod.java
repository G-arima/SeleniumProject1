...
@FindBy(xpath="(//div[contains(@class,'a-radio')]/label/input[@name='ppw-instrumentRowSelection'])[1]")
WebElement radio2;
	
@FindBy(xpath="(//div[contains(@class,'a-radio')]/label/input[@name='ppw-instrumentRowSelection'])[2]")
WebElement radio3;
...
public void AmazonPay() {
	WebDriverWait wait1=new WebDriverWait(driver,Duration.ofSeconds(20));
			wait1.until(ExpectedConditions.elementToBeClickable(radio2)).click();
}
public void cards() {
